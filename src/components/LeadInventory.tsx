      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {sorted.length === 0 ? (
          ...
          sorted.map((item) => (
            <div
              key={item.campaignId}
              className="bg-surface p-5 rounded-lg border border-border-default hover:border-text-muted transition-all relative"
            >
              {item.isLow && (
              ...
              <div className="w-full bg-surface-elevated h-1 rounded-full mb-3">
                <div
